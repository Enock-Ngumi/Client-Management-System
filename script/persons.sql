USE [master]
GO
/****** Object:  Database [persons]    Script Date: 3/21/2026 3:24:16 PM ******/
CREATE DATABASE [persons]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'crudapp', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL16.SQLEXPRESS\MSSQL\DATA\crudapp.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'crudapp_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL16.SQLEXPRESS\MSSQL\DATA\crudapp_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
 WITH CATALOG_COLLATION = DATABASE_DEFAULT, LEDGER = OFF
GO
ALTER DATABASE [persons] SET COMPATIBILITY_LEVEL = 160
GO
...
GO
ALTER DATABASE [persons] SET QUERY_STORE = ON
GO
ALTER DATABASE [persons] SET QUERY_STORE (OPERATION_MODE = READ_WRITE, CLEANUP_POLICY = (STALE_QUERY_THRESHOLD_DAYS = 30), DATA_FLUSH_INTERVAL_SECONDS = 900, INTERVAL_LENGTH_MINUTES = 60, MAX_STORAGE_SIZE_MB = 1000, QUERY_CAPTURE_MODE = AUTO, SIZE_BASED_CLEANUP_MODE = AUTO, MAX_PLANS_PER_QUERY = 200, WAIT_STATS_CAPTURE_MODE = ON)
GO
USE [persons]
GO
/****** Object:  Table [dbo].[persons]    Script Date: 3/21/2026 3:24:16 PM ******/
SET ANSI_NULLS ON
GO
...
CREATE TABLE [dbo].[persons](
 ...
 CONSTRAINT [PK_crudapp] PRIMARY KEY CLUSTERED 
(
	[id] ASC
